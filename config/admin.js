...
// thiết lập Hũ Audition
HU.findOne({game:'audition', type:100, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'audition', 'type': 100, red: true, 'bet': 500000, 'min': 500000});
	}
})

HU.findOne({game:'audition', type:1000, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'audition', 'type': 1000, red: true, 'bet': 5000000, 'min': 5000000});
	}
})

HU.findOne({game:'audition', type:10000, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'audition', 'type': 10000, red: true, 'bet': 50000000, 'min': 50000000});
	}
})

// thiết lập Hũ LanKwaiFong
HU.findOne({game:'lankwaifong', type:100, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'lankwaifong', 'type': 100, red: true, 'bet': 500000, 'min': 500000});
	}
})

HU.findOne({game:'lankwaifong', type:1000, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'lankwaifong', 'type': 1000, red: true, 'bet': 5000000, 'min': 5000000});
	}
})

HU.findOne({game:'lankwaifong', type:10000, red: true}, {}, function(err, data){
	if (!data) {
		HU.create({'game':'lankwaifong', 'type': 10000, red: true, 'bet': 50000000, 'min': 50000000});
	}
})
